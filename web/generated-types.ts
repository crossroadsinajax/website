...
export type UserQuery = (
  ...
  & { currentUser?: Maybe<(
    { __typename?: 'UserType' }
    & Pick<UserType, 'username' | 'firstName' | 'lastName' | 'isChatmod'>
  )> }
);
...
export type HomePageQuery = (
  ...
  & { currentService: (
    { __typename?: 'ServicePageNode' }
    & Pick<ServicePageNode, 'slug' | 'title'>
  ) }
);
...
export type ServicePageQuery = (
  ...
  & { services?: Maybe<(
    ...
    & { edges: Array<Maybe<(
      ...
      & { node?: Maybe<(
        { __typename?: 'ServicePageNode' }
        & Pick<ServicePageNode, 'date' | 'id' | 'pk' | 'slug' | 'title' | 'description' | 'streamLink'>
      )> }
    )>> }
  )> }
);
...
export type ServicePagesQuery = (
  ...
  & { services?: Maybe<(
    ...
    & { edges: Array<Maybe<(
      ...
      & { node?: Maybe<(
        { __typename?: 'ServicePageNode' }
        & Pick<ServicePageNode, 'slug' | 'title' | 'description'>
      )> }
    )>> }
  )> }
);
...
export function useServicePageQuery(baseOptions: Apollo.QueryHookOptions<ServicePageQuery, ServicePageQueryVariables>) {
        return Apollo.useQuery<ServicePageQuery, ServicePageQueryVariables>(ServicePageDocument, baseOptions);
      }
export function useServicePageLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ServicePageQuery, ServicePageQueryVariables>) {
          return Apollo.useLazyQuery<ServicePageQuery, ServicePageQueryVariables>(ServicePageDocument, baseOptions);
        }
 ...
 * });
 */
export function useServicePagesQuery(baseOptions?: Apollo.QueryHookOptions<ServicePagesQuery, ServicePagesQueryVariables>) {
        return Apollo.useQuery<ServicePagesQuery, ServicePagesQueryVariables>(ServicePagesDocument, baseOptions);
      }
export function useServicePagesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ServicePagesQuery, ServicePagesQueryVariables>) {
          return Apollo.useLazyQuery<ServicePagesQuery, ServicePagesQueryVariables>(ServicePagesDocument, baseOptions);
        }
export type ServicePagesQueryHookResult = ReturnType<typeof useServicePagesQuery>;
export type ServicePagesLazyQueryHookResult = ReturnType<typeof useServicePagesLazyQuery>;
export type ServicePagesQueryResult = Apollo.QueryResult<ServicePagesQuery, ServicePagesQueryVariables>;